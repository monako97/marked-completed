...
declare namespace marked {
    ...
    class Tokenizer {
        ...
        textEmoji(src: string): Tokens.TextEmoji;
        codeEmoji(src: string): Tokens.CodeEmoji;
        mark(src: string): Tokens.Mark;
        sup(src: string): Tokens.Sup;
        sub(src: string): Tokens.Sub;
        toc(src: string): Tokens.Toc;
    }
    ...
    class Renderer {
        ...
        textEmoji(text: string): string;
        codeEmoji(text: string): string;
        mark(code: string): string;
        sub(code: string): string;
        sup(code: string): string;
        s(text: any): string;
        ins(text: any): string;
